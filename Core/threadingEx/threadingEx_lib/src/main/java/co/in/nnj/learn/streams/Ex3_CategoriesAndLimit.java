...
public class Ex3_CategoriesAndLimit {
    public static void main(final String[] args) {
        ...
        List<Book> top2BooksWithMaxPage = books.stream().sorted((b1, b2) -> {
